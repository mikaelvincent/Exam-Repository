    ...
    <nav>
        <div class="container py-4 py-xl-5">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><span>Contributors</span></li>
            </ol>
        </div>
    </nav>
    <main>
            ...
            <div class="row gy-5 row-cols-1 row-cols-lg-2 row-cols-xxl-3 mb-5">
                <div class="col">
                    <div class="card border-0">
                        <div class="card-body d-flex align-items-center p-0"><img class="rounded-circle me-3 object-fit-cover" src="https://avatars.githubusercontent.com/u/90804797?v=4" height="130" width="130" alt="Profile picture of mikaelvincent.dev">
                            <div>
                                <h3 class="fw-bold mb-0">mikaelvincent.dev</h3>
                                <p class="font-monospace text-muted mb-1">mikaelvincent</p><a href="#" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-github fs-2">
